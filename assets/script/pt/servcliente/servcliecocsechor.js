...
listEquipo= function(){    
    ...
    otblListEquipos = $('#tblListEquipos').DataTable({    
        ...
        'columns'	: [
            ...
            {data: 'FABRI', "class":"col-sm"},
            {data: 'CAPA', "class":"col-s"},
            {data: 'MEDIOCAL', "class":"col-sm"},
            {data: 'NROEQUI', "class":"col-s"},
            {data: 'NROCANAST', "class":"col-s"},
            {data: 'IDENTIF', "class":"col-s"},
            {data: 'PRODUCTO', "class":"col-xm"},
            {data: 'PRESENTA', "class":"col-sm"},
        ],
        rowGroup: {
...
listRecintos= function(){    
    ...
    otblListRecintos = $('#tblListRecintos').DataTable({    
        ...
        'columns'	: [
            ...
            {data: 'NROCOCHES', "class":"col-sm"},
            {data: 'IDENTIF', "class":"col-sm"},
            {data: 'PRODUCTO', "class":"col-sm"},
            {data: 'PRESENTA', "class":"col-sm"},
        ],
        rowGroup: {
            startRender : function ( rows, group ) {
