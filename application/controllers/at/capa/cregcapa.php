...
class Cregcapa extends CI_Controller {
   ...
   /** CAPACITACIONES **/ 
    ...
    public function setcapadet() { // Registrar informe PT
		...
		$chkSolo 		= $this->input->post('mhdnchecksolo');
		$mcbosoloexpo 	= $this->input->post('mcbosoloexpo');
		$msolotxtHoraini 	= $this->input->post('msolotxtHoraini');
		$msolotxtHorafin 	= $this->input->post('msolotxtHorafin');
		$mhdnfechacapasolo 	= $this->input->post('mhdnfechacapasolo');
        ...
        $parametros = array(
            ...
            '@chkSolo'			=>  $chkSolo,
            '@id_capaexpo'		=>  $mcbosoloexpo,
            '@hora_inicapa'		=>  $msolotxtHoraini,
            '@hora_fincapa'		=>  $msolotxtHorafin,
            '@fecha_capa'		=>  substr($mhdnfechacapasolo, 6, 4).'-'.substr($mhdnfechacapasolo,3 , 2).'-'.substr($mhdnfechacapasolo, 0, 2),
            '@accion'			=>  $accion
        );
