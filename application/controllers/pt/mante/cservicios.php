 ...
 * Class Cservicios
 *
 * @property mservicios mservicios
 */
class Cservicios extends CI_Controller
{
    ...
    {
        parent::__construct();
        $this->load->model('pt/mante/mservicios', 'mservicios');
    }

    /**
     * Vista para visualizar las servicios
     */
    public function lista()
    {
        ...
        $servicios = $this->mservicios->lista($cusuario, $nombre);
        foreach ($servicios as $row){
            ?>
            <tr>
                <td><?php echo $row->idptservicio ?></td>
                <td><?php echo $row->descripcion_serv ?></td>
                <td><?php echo $row->vigencia ?></td>
                <td><?php echo $row->abreviatura_serv  ?></td>
