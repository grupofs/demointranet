                ...
                <div class="card card-success card-outline card-tabs">
                    <div class="card-header p-0 pt-1 border-bottom-0">            
                        <ul class="nav nav-tabs tabfs" id="tabinforme" role="tablist">     
                            <li class="nav-item">
                                <a class="nav-link active" id="tabinforme-eval-tab" data-toggle="pill" href="#tabinforme-eval" role="tab" aria-controls="tabinforme-eval" aria-selected="true">EVALUACION</a>
                            </li>
                            <li class="nav-item">
                    ...
                    <div class="card-body">
                        <div class="tab-content" id="tabinforme-tabContent">
                            <div class="tab-pane fade show active" id="tabinforme-eval" role="tabpanel" aria-labelledby="tabinforme-eval-tab">
